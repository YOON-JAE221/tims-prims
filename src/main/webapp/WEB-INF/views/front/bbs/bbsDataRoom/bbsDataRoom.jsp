...
<main id="main">
  ...
  <!-- ======= 2컬럼 레이아웃 ======= -->
  <c:set var="activeLnb" value="dataroom" scope="request" />
  <div class="lnb-layout">
    ...
    <div class="lnb-content">
      ...
      <div class="bbsCommon">
        ...
        <form id="pagingForm" action="${ctx}/bbs/viewBbsDataRoom" method="post">
          <input type="hidden" name="brdCd" value="${brdCd}" />
        ...
        <div class="bbsCommon-searchRow">
          <form class="bbsCommon-searchForm" method="post" action="${ctx}/bbs/viewBbsDataRoom">
            <input type="hidden" name="brdCd" value="${brdCd}" />
