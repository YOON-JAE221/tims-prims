...
<head>
  ...
  <!-- CSS -->
  <link href="${ctx}/resources/front/css/common.css?v=202503100004" rel="stylesheet">
  <link href="${ctx}/resources/front/css/main.css?v=202503100004" rel="stylesheet">

  <!-- Common JS -->
  <script src="${ctx}/resources/common/util/js/common.js?v=202503100004" charset="UTF-8"></script>
