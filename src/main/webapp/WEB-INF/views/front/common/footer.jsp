  ...
  <div class="footer-main">
    ...
    <div class="footer-right">
      <div class="footer-nav-col">
        <h4>매물유형</h4>
        <ul>
          <li><a href="${ctx}/property/viewPropertyList?type=apt">아파트</a></li>
          <li><a href="${ctx}/property/viewPropertyList?type=officetel">오피스텔</a></li>
          <li><a href="${ctx}/property/viewPropertyList?type=shop">상가</a></li>
          <li><a href="${ctx}/property/viewPropertyList?type=office">사무실</a></li>
        </ul>
      </div>
      <div class="footer-nav-col">
        <h4>서비스</h4>
        <ul>
          ...
          <li><a href="${ctx}/property/viewPropertyList">매물검색</a></li>
